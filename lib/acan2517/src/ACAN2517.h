...
//······················································································································
  ...
  public: bool sleep2517FD(); // set device in sleep mode, return true if set to sleep mode
  public: bool wake2517FD(); // set device in configuration mode, return true if set to configuration mode
  public: bool en_wake_on_can2517FD();
  public: bool dis_wake_on_can2517FD();
  public: bool set_listen_only2517FD();

  public: bool  en_transceiver2517FD();
  public: bool  dis_transceiver2517FD();
  public: bool set_normal_mode2517FD();

//--- Error code returned by begin
  public: static const uint32_t kRequestedConfigurationModeTimeOut  = ((uint32_t) 1) <<  0 ; // 1
  public: static const uint32_t kReadBackErrorWith1MHzSPIClock      = ((uint32_t) 1) <<  1 ; // 2
  public: static const uint32_t kTooFarFromDesiredBitRate           = ((uint32_t) 1) <<  2 ; // 4
  public: static const uint32_t kInconsistentBitRateSettings        = ((uint32_t) 1) <<  3 ; // 8
  public: static const uint32_t kINTPinIsNotAnInterrupt             = ((uint32_t) 1) <<  4 ; // 16
  public: static const uint32_t kISRIsNull                          = ((uint32_t) 1) <<  5 ; // 32
  public: static const uint32_t kFilterDefinitionError              = ((uint32_t) 1) <<  6 ; // 64
  public: static const uint32_t kMoreThan32Filters                  = ((uint32_t) 1) <<  7 ; // 128
  public: static const uint32_t kControllerReceiveFIFOSizeIsZero    = ((uint32_t) 1) <<  8 ; // 256
  public: static const uint32_t kControllerReceiveFIFOSizeGreaterThan32 = ((uint32_t) 1) << 9 ; // 512
  public: static const uint32_t kControllerTransmitFIFOSizeIsZero    = ((uint32_t) 1) << 10 ; // 1024
  public: static const uint32_t kControllerTransmitFIFOSizeGreaterThan32 = ((uint32_t) 1) << 11 ; // 2048
  public: static const uint32_t kControllerRamUsageGreaterThan2048   = ((uint32_t) 1) << 12 ; // 4069
  public: static const uint32_t kControllerTXQPriorityGreaterThan31  = ((uint32_t) 1) << 13 ; // 8192
  public: static const uint32_t kControllerTransmitFIFOPriorityGreaterThan31 = ((uint32_t) 1) << 14 ; // 16384
